...
export default function BodySection(){
  return (
    <div className='wrapperBodySection flex flex-col items-center gap-[2rem] mt-[1rem]'>
      <div id='containerImgFamilyWellness' className=' w-[95%] h-[40rem] rounded-md overflow-hidden relative'>     
        <div className='wrapperChevronsLeftAndRight flex gap-[2rem] absolute bottom-[1rem] right-[1rem] text-white font-extrabold	 text-[1.5rem] cursor-pointer'>
          <i class="fa-solid fa-chevron-left hover:text-[#181616] transition" title='previous image'></i>
          <i class="fa-solid fa-chevron-right hover:text-[#9A1F48] transition" title='next image'></i>

        </div>   
      </div>

      <div id='divThinkHealthThinkMessage' className='bg-[#9A1F48] text-white flex flex-col gap-[2rem] items-center p-[2rem]  rounded-md w-[100%]'>
      ...
      <div className='wrapperThreeParagraphs flex flex-col border-b-2 border-[#B7B7B7] w-[100%]  pt-[1rem] p-[3rem] gap-[1.5rem] text-[1.1rem] font-medium items-center'>
      ...
      <div className='flex flex-col p-[2rem] gap-[1rem]'>
        <h2 className='familyWellnessMassageTherapy text-[#9A1F48] text-[1.8rem] font-medium'>Family Wellness Massage Therapy</h2>
